...
public class YoloV4Classifier implements Classifier {
    ...
    // config yolov4 tiny
    private static final int[] OUTPUT_WIDTH_TINY = new int[]{540, 540};// {2535,2535} for 416*416 RGB inputs, {735,735} for 224*224 RGB inputs, {540,540} for 192*192 RGB inputs
